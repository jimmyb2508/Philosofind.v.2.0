...
class EnlightenmentAllQuotes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      quotes: []
  ...
  allQuotes() {
    Axios.get(`https://murmuring-depths-99830.herokuapp.com/quotes/enlightenment`).then(res => {
      console.log(res);
...
export default EnlightenmentAllQuotes;